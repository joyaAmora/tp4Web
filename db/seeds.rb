...
paul = User.create!(nom: "Paul", prenom: "Tremblay", email: "paul@tremblay.com", password: "abcdef", is_admin: false)
george = User.create!(nom: "George", prenom: "Germain", email: "george@germain.com", password: "defdef", is_admin: false)
jacque = User.create!(nom: "Jacque", prenom: "Germain", email: "jacque@germain.com", password: "ghidef", is_admin: false)
daniel = User.create!(nom: "Daniel", prenom: "Peterson", email: "daniel@peterson.com", password: "jkldef", is_admin: false)
robert = User.create!(nom: "Robert", prenom: "Skywalker", email: "robert@skywalker.com", password: "mnodef", is_admin: false)
Jade = User.create!(nom: "Jade", prenom: "Phaneuf", email: "jade@phaneuf.com", password: "123456", is_admin: true)
